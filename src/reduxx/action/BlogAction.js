...
export const fetchBlog = (params) => async (dispatch) => {
  ...
  try {
    await Axios.get(`${BaseURL}${apiEndPoints.GETBLOG}`, params)
      .then((response) => {
...
export const fetchWhatsNew = (params) => async (dispatch) => {
  dispatch({ type: START_LOADING });
  try {
    await Axios.get(`${BaseURL}${apiEndPoints.GETWHATSNEW}`, params)
      .then((response) => {
        if (response.status === 200) {
...
export const fetcEBooks = (params) => async (dispatch) => {
  dispatch({ type: START_LOADING });
  try {
    await Axios.get(`${BaseURL}${apiEndPoints.GETEBOOK}`, params)
      .then((response) => {
        if (response.status === 200) {
...
export const fetchDaliyVocab = (params) => async (dispatch) => {
  dispatch({ type: START_LOADING });
  try {
    await Axios.get(`${BaseURL}${apiEndPoints.GET_DALYVOCAB}`, params)
      .then((response) => {
        if (response.status === 200) {
...
export const fetchJobs = (params) => async (dispatch) => {
  dispatch({ type: START_LOADING });
  try {
    await Axios.get(`${BaseURL}${apiEndPoints.GET_JOB}`, params)
      .then((response) => {
        if (response.status === 200) {
