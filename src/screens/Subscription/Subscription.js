          ...
          <Row className="justify-content-center">
            <Col lg={4} sm={6}>
              <div className="subscription-card">
                ...
                <br />
                <Button>
                  <Link to="/subscription-payment">Get Started Now</Link>
                </Button>
                <ul>
                  <li>
                  ...
                  <li>
                    <i className="fa fa-times-circle" /> Lorem Ipsum is simply
                    dummy
                  </li>
                  <li>
                    <i className="fa fa-times-circle" /> Lorem Ipsum is simply
            ...
            <Col lg={4} sm={6}>
              <div className="subscription-card">
                <h2>Pro Plus</h2>
                <p>Lorem Ipsums who need quick access to basic features.</p>
                <a>
                  $100 <span>/ Month</span>
                </a>
                <br />
        ...
        <Container fluid className="container-space">
          ...
          <div className="mt-4 mb-4">
            <Row className="justify-content-end text-center">
              <Col lg={3} sm={4} xs={4}>
                <h6>Free</h6>
                <Button variant="success" className="sub-btn">
                  Get started
                </Button>
              </Col>
              <Col lg={3} sm={4} xs={4}>
